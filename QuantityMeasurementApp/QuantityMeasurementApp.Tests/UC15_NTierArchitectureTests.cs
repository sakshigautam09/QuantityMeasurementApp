...
namespace QuantityMeasurementApp.Tests
{
    ...
    internal class InMemoryRepository : IMeasurementHistoryRepository
    {
    ...
    public class UC15_NTierArchitectureTests
    {
        private static IQuantityMeasurementService CreateService()
            => new QuantityMeasurementService(new InMemoryRepository(), null, NullLogger<QuantityMeasurementService>.Instance);

        private static (IQuantityMeasurementService svc,
                        IMeasurementHistoryRepository repo)
            CreateServiceWithRepo()
        {
            var repo = new InMemoryRepository();
            return (new QuantityMeasurementService(repo, null, NullLogger<QuantityMeasurementService>.Instance), repo);
        }
        ...
        public void testLayerDecoupling_ServiceChange()
        {
            ...
            var ctrl2 = new QuantityMeasurementController(
                            new QuantityMeasurementService(repo, null, NullLogger<QuantityMeasurementService>.Instance), repo);
        ...
        {
            var repo = new InMemoryRepository();
            var svc  = new QuantityMeasurementService(repo, null, NullLogger<QuantityMeasurementService>.Instance);
